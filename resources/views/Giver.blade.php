...
<div
    class="flex mx-10 mb-3 items-center justify-between p-3 mb-3 text-2xl font-semibold text-white 
    ...
    <label
        ...
        type="button" for="add-giver" style="background-color: #2A9D8F">
        เพิ่มข้อมูล
    </label>
...
<div class="overflow-x-auto relative shadow-md sm:rounded-lg mx-10">
    <table class="w-full table-auto  text-xl text-left text-gray-500 dark:text-gray-400">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td scope="row" class="py-4 px-6 font-bold text-gray-700 whitespace-nowrap dark:text-white text-right">
                    <a href="#" class="font-bold text-gray-500 hover:text-blue-500"> <label
                            for="edit-giver-{{$rows->member_id}}">แก้ไข</label></a>
                    <input type="checkbox" id="edit-giver-{{$rows->member_id}}" class="modal-toggle" />
                    <div class="modal overflow-scroll">
                        <div class="modal-box">
                        <div class="mx-2 bg-white rounded-lg shadow-md">
                            <div
                            ...
                            <div class="w-full p-5">
                                ...
                                <div class="modal-action">
                                    <label for="edit-giver-{{$rows->member_id}}"
                                        class="bg-red-500 text-white active:bg-pink-500 font-bold uppercase text-xl px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">ปิด</label>
                                </div>
                            </div>
                        </div>
