...
<div
    ...
    <div class="flex items-center">
        <span>จัดการข้อมูลผู้จัดส่ง</span>
    </div>
    <label
            ...
            <div class="w-full p-5">
                <form class="mt-8 space-y-6" action="{{ route('member.store') }}" method="POST">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div>
                            <div class="text-2xl text-gray-700 m-1">รหัสผ่าน :</div>
                        ...
                        <div>
                            <div class="text-2xl text-gray-700 m-1">ยืนยันรหัสผ่าน :</div>
                        ...
                        <input name="type" type="hidden" autocomplete="current-password" required
                            ...
                            value="sender">
                        <div>
                            <div class="text-2xl text-gray-700 m-1 font-bold text-white text-left">ระบุสถานะ :</div>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="py-4 px-6">
                    ...
                    หมู่ที่ {{$rows->group_no}} ตำบล {{$rows->district}} อำเภอ {{$rows->sub_district}} จังหวัด
                    {{$rows->province}}
                ...
                <td class="py-4 px-6 text-right">
                    <a href="#" class="font-medium text-gray-500 hover:text-blue-500"> <label
                            for="edit-sender-{{$rows->member_id}}">แก้ไข</label></a>
                    <input type="checkbox" id="edit-sender-{{$rows->member_id}}" class="modal-toggle" />
                    <div class="modal">
                        <div class="w-screen mx-32 bg-white rounded-lg shadow-md">
                            <div
                                class="bg-indigo-500 rounded-sm text-white p-3 text-3xl font-bold text-white text-left ">
                                แก้ไขข้อมูลผู้รัจัดส่ง
                            </div>
                            <div class="w-full p-5">
                                <form class="mt-8 space-y-6" action="{{ route('member.update',$rows->member_id)}}"
                                    ...
                                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
                                        ...
                                        <div>
                                            ...
                                            <select name="status" type="text"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                <option value="{{$rows->status}}">{{$rows->status}}</option>
                                                <option value="online">online</option>
                                                <option value="offline">offline</option>
                                            </select>
                                        </div>
                                ...
                                <div class="modal-action">
                                    <label for="edit-sender-{{$rows->member_id}}"
                                        class="bg-red-500 text-white active:bg-pink-500 font-bold uppercase text-xl px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">ปิด</label>
                                </div>
                            </div>
                        </div>
